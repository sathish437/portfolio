...
export default function SkillCategorySection({ category, index = 0 }) {
    ...
    return (
        ...
        >
            ...
            <div
                className={`relative rounded-2xl border transition-colors duration-300 overflow-visible ${
                    open
            ...
            >
                ...
                >
                    ...
                    >
                        <CategoryIcon
                            className={`w-5 h-5 transition-colors duration-300 ${open ? 'text-accent' : 'text-accent/50'}`}
                            strokeWidth={1.5}
                        />
                    </div>

                    <h3
                        className={`flex-1 text-base font-bold tracking-wide transition-colors duration-300 ${
                ...
                {open && (
                    <>
                        <div className="h-px bg-accent/10 mx-6" />
                        <div className="flex flex-col gap-2 px-4 pb-4 pt-3 w-full">
